...
train_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root='/root/ytx/mmpretrain/data/fruit30_train/training_set',
...
val_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root='/root/ytx/mmpretrain/data/fruit30_train/val_set',
...
param_scheduler = dict(
    type='MultiStepLR', by_epoch=True, milestones=[6, 12, 18], gamma=0.1)
